...
namespace Amw.RabbitMq.Client
{
    public class RabbitMQHelper
    {
        ...
        private readonly static ConcurrentDictionary<IConnection, int> MQConnectionPoolUsingDicNew;//连接使用率
        ...
        SelectMQConnectionLine:
            ...
            MQConnectionPoolSemaphore.WaitOne();//当小于MaxConnectionCount时，会直接进入，否则会等待直到空闲连接出现

...
using Amw.Identity.NetfxDemo.Models;
using Amw.Identity.NetfxDemo.Providers;
using Amw.Identity.NetfxDemo.Results;

namespace Amw.Identity.NetfxDemo.Controllers
{
    [Authorize]
